...
from .utils import _generate_mock_data, plot_alignment_result
...
def test_plot_alignment_result():
    ...
    plot_alignment_result(a, b_prime, aligned_b, pi=None, title="Transport Plan", work_dir=None, show=True)